...
function getDriveClient() {
    ...
    console.log('[MedGzuri] getDriveClient: Service account JSON length:', raw.length);
    ...
    console.log('[MedGzuri] getDriveClient: Parsed OK, project_id:', credentials.project_id, 'client_email:', credentials.client_email);
