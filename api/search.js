...
პასუხი უნდა მოიცავდეს:
1. executive_summary — 3 წინადადებიანი შეჯამება
2. რეკომენდებული კლინიკები (სახელი, ქვეყანა, სპეციალიზაცია)
3. სავარაუდო ფასები (თუ ხელმისაწვდომია)
4. მკურნალობის ტექნოლოგიები
5. საკონტაქტო ინფორმაცია ან ვებსაიტი
6. comparison_table — კლინიკების შედარება ცხრილით
...
პასუხი მხოლოდ JSON ფორმატში (არანაირი დამატებითი ტექსტი JSON-ისაგ გარეთ):
{
  ...
  "comparison_table": { "headers": ["კლინიკა", "ქვეყანა", "ფასი", "სპეციალიზაცია", "ენები"], "rows": [["...", "...", "...", "...", "..."]] },
  "action_steps": ["1. ექიმთან კონსულტაცია", "2. ...", "3. ..."]
}`
    };
